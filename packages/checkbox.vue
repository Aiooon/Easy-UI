<template>
  <label class="ez-checkbox" :class="{'is-checked':isChecked}">
    <span class="ez-checkbox_input">
      <span class="ez-checkbox_inner"></span>
      <input type="checkbox"
        class="ez-checkbox_original"
        :name="name"
        v-model="model"
        :value="label"
      >
    </span>
    <span class="ez-checkbox_label">
      <slot></slot>
